...
public final class ItemPokemonBinding implements ViewBinding {
  ...
  private ItemPokemonBinding(@NonNull MaterialCardView rootView, @NonNull ImageView pokemonImage,
  ...
  public static ItemPokemonBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemPokemonBinding((MaterialCardView) rootView, pokemonImage, pokemonName);
    }
